 ...
 * @param bool $usecache rebuild activities from cache if modinfo exists, use true for partial course rebuild
 ...
 * @return void
 */
function course_purge_module_cache(object $cm): void {
    $cmid = $cm->id;
    $courseid = $cm->course;
    $cache = cache::make('core', 'coursemodinfo');
    $cache->acquire_lock($courseid);
