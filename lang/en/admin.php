...
$string['numcoursesincombo_help'] = 'Maximum number of courses in combo list, large number of courses displayed in combo list could be slow, if number of courses is higher than this value, the course tree won\'t be displayed, instead, redirect users to course page to see the whole list.';
